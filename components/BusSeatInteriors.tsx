...
const SLIDES = [
  {
    ...
    alt: "Luxury Bus Interior - Panoramic View"
  },
  {
    url: "/images/products/PASSENGER VAN/_MG_5696.JPG",
    alt: "Premium Bus Seating - Comfort & Style"
  },
  {
  ...
  },
  {
    ...
    alt: "Customized Bus Interior Craftsmanship"
  }
];

export default function BusSeatInteriors() {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div ref={textRef} className="w-full lg:w-1/2">
            ...
            <p className="text-black/70 text-lg leading-relaxed mb-10 max-w-xl">
              Elevate the passenger experience with our specialized bus interior solutions. 
